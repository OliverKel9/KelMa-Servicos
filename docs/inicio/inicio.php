...
<head>
    ...
    <link rel="stylesheet" href="/docs/Inicio/inicio.css">
    <link rel="stylesheet" href="/docs/Inicio/responcivo-I.css">
</head>
    ...
    <header class="header">
        ...
        <div class="img-headline">
            <img style="max-width: 70%;" src="/docs/img/Ferramentas.png.png">
        </div>
    ...
    <section>
        ...
        <div class="Servicos">
            <a href="/docs/serviços/serviços.html">
            <div class="card">
                <img src="/docs/img/Martelo.png">
                <div class="card-text">
                <h3>Marceneiro</h3>
            ...
            <div class="card">
                <div class="card-text">
                    <img src="/docs/img/chave.png.png">
                    <h3>Eletricista</h3>
            ...
            <div class="card">
                <div class="card-text">
                    <img src="/docs/img/Chave-ingkesa.png.png">
                    <h3>Encanador</h3>
